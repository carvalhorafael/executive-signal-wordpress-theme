...
const translations = new Map([
  ...
  ["Free Materials", "Materiais Gratuitos"],
  [
    "Controls the introductory copy shown on the free materials page.",
    "Controla o texto introdutório exibido na página de materiais gratuitos.",
  ],
  ["Free materials eyebrow", "Texto superior de materiais gratuitos"],
  ["Free materials title", "Título de materiais gratuitos"],
  ["Free materials description", "Descrição de materiais gratuitos"],
  ["Courses", "Cursos"],
  ["Course", "Curso"],
  ["Online", "Online"],
  ...
  ["About this material", "Sobre este material"],
  ["Pages or items", "Páginas ou itens"],
  ["File size", "Tamanho do arquivo"],
  ["Who it is for", "Para quem é"],
  ["Downloads", "Downloads"],
  ["What is inside", "O que está incluído"],
  [
    "I do not want this material to just sit in your files. Use it to organize your ideas, make a decision, and take action.",
    "Não quero que este material fique apenas nos seus arquivos. Use-o para organizar suas ideias, tomar uma decisão e agir.",
  ],
  [
    "Download it now and consult it whenever you need.",
