...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'entry entry--single free-material-single es-resource-capture-landing' ); ?> data-variant="classic" itemscope itemtype="https://schema.org/CreativeWork">
	<header class="es-resource-capture-hero" data-visual-placement="below-title">
		...
		<div class="es-resource-capture-hero__panel">
			<aside id="capture" class="es-resource-capture-panel" aria-labelledby="free-material-capture-title">
				...
				<div class="es-resource-capture-panel__body">
					...
					<form class="es-resource-capture-panel__form" action="<?php echo esc_url( $capture_form_action ); ?>" method="post">
						...
						<?php foreach ( executive_signal_get_free_material_capture_utm_fields() as $utm_field ) : ?>
							...
							>
						<?php endforeach; ?>
						<p class="es-resource-capture-panel__field">
						...
						<div class="es-resource-capture-panel__action">
				...
				<div class="es-resource-capture-panel__footer">
					<p><?php esc_html_e( 'No payment required. Keep the material for future reference.', 'executive-signal-wordpress-theme' ); ?></p>
				</div>
			</aside>
		</div>
	</header>
	...
	<div class="es-resource-capture-landing__final-cta">
		<section class="es-resource-final-cta" aria-labelledby="free-material-final-cta-title">
			<div>
				<p class="es-resource-final-cta__eyebrow"><?php esc_html_e( 'Ready to use', 'executive-signal-wordpress-theme' ); ?></p>
